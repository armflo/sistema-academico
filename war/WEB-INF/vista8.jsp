					...
					<tr><td>
                        ...
                        <tr><td>
                            <table cellpadding="0" style="width: 320px;">
                                ...
                                <tr><td align="right">
                            	<label for="Login1_Password" >Clave&nbsp;de&nbsp;Acceso&nbsp;:</label>
                                </td>
                       ...
                       <tr><td align="center">
                           <input type="button" name="Login1$LoginButton" value="Iniciar sesión"   
                           class="objeto_derecha b_boton b_acceder" onclick="location.href='vista?number=7'">
                           </td>
                       </tr>
